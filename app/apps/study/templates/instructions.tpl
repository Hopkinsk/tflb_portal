...
<div class="js-page-1">
	...
	<span class="col-sm-12">
		...
		<div class="row">
			<div class="col-sm-12 input-img"></div>
		</div>		
		
		<p>


		<button class="btn btn-default continue-btn pull-right js-continue-1"> Continue </button>
	</span>
</div>

<div class="js-page-2 hidden">
	<span class="col-sm-12">
