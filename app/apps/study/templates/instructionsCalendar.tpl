...
<div class="panel panel-default user-instructions calendar">
...
<h3 class="text-center underline title"> Instructions </h3>
</span>
...
<div class="js-page-1">
	...
	<span class="col-sm-12">
		...
		<h3 class="underline heading"> What To Fill In </h3>
		<p> 
		<ul>
			<li> For each day in which you drank, please enter in the <b> total number of drinks</b> you had (as a whole number)</li>
			<li> For days in which you used marijuana, please select <b>Yes</b> for marijuana use </li>
			<li> If you use marijuana daily, please check the box <b>"I smoke marijuana daily"</b> </li>
		</ul>
		</p>
		<div class="row">
			<div class="col-sm-12 input-img calendar"></div>
		</div>		
...
<div class="js-page-2"><br>
	<span class="col-sm-12">
		<h3 class="underline heading"> Standard Drinks </h3>

		<span class="text-center">
			We want you to record your drinking on the calendar using <b> standard drinks</b>. 
			<br><br>
		</span>

		<div class="row">
			<div class="col-sm-12 standard-drink-img calendar"></div>
		</div>
		<span class="text-center">
...
<div class="js-page-3"><br>
	<span class="col-sm-12">
	<h3 class="underline heading"> Personal Events </h3>
	<p class="lg-text">
	...
	<div class="row">
		<div class="col-sm-12 add-event-img calendar"></div><br>
	</div>
